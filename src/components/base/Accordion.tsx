...
const Accordion: React.FC<AEMComponentProps> = (props) => {
    const {resource, type, data} = props;
    const [openItems, setOpenItems] = React.useState<Set<number>>(new Set([0])); // Optionally open the first item by default
